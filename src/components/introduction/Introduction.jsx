      ...
      <div className="w-full flex flex-col justify-between max-lg:text-center">
        <div className="pt-13 me-31.5 w-full lg:w-auto transition-all duration-500">
          ...
          <p className="text-xs xxs:text-lg lg:text-[18px] my-6">
            ...
            <span className="block mt-3">I’m a dedicated and creative Front-End Developer with six months of internship experience in developing responsive, interactive, and user-focused websites. My journey in web development began with a curiosity for how design and functionality come together to create digital experiences that engage users. Over time, I’ve developed a strong technical foundation and a deep passion for building clean, efficient, and visually appealing interfaces.</span>
          </p>
        </div>
